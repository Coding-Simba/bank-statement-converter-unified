#!/usr/bin/env python3
"""Test Citizens Bank statement parser"""

from backend.citizens_parser import parse_citizens

pdf_path = '/Users/MAC/Desktop/pdfs/1/USA Citizens Bank.pdf'

print("Testing Citizens Bank statement...")
print("=" * 60)
