#!/usr/bin/env python3
"""Test Monese bank statement parser"""

from backend.monese_simple_parser import parse_monese_simple as parse_monese

pdf_path = '/Users/MAC/Desktop/pdfs/1/UK Monese Bank Statement.pdf'

print("Testing Monese bank statement...")
print("=" * 60)
